...
public class ManagedBlockchainService {
    ...
    public void initChannel() throws AppException {
        ...
        this.channel = initializeChannel(client, false);
     ...
     *
     */
    public void initChannel(boolean isInvoke) throws AppException {
        // Initialize Channel
        log.info("Initializing channel ...");
        this.channel = initializeChannel(client, isInvoke);
        log.info("Channel initialized!");
    }
     ...
     * @return Channel
     */
    private Channel initializeChannel(HFClient client, boolean isInvoke) throws AppException {
	    ...
	    log.info("Peer 1: "+ AMBConfig.ORG1_PEER_0 +":"+ AMBConfig.ORG1_PEER_0_URL);
            log.info("Peer 2: "+ AMBConfig.ORG2_PEER_0 +":"+ AMBConfig.ORG2_PEER_0_URL);
	    log.info(properties.get("pemBytes").toString());


	    log.info("Is Invoke: "+ isInvoke);

	    if(isInvoke){
		log.info("Adding Org2 peer");

		// Configure Peer
	        Peer peerorg2 = client.newPeer(AMBConfig.ORG2_PEER_0, AMBConfig.ORG2_PEER_0_URL, properties);
		channel.addPeer(peerorg2);
		log.info("Org2 peer added successfully");
            }
	...
	log.info("Params: "+ chaincodeName +":"+ functionName +":"+ args);
	log.info(""+channel);
	...
	log.info("Response 1: ", res);
	    ...
	    log.info("Proposal Response: ", pres);
	    log.info(""+pres);
